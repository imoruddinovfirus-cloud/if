...
def create_card_payment():
    amount = 137.6  # чтобы пользователь заплатил 150 с комиссией 9%
...
def create_sbp_payment():
    amount = 138.9  # чтобы пользователь заплатил 150 с комиссией 8%
    external_id = request.args.get('externalId')
    user_id = request.args.get('userId')
...
def create_crypto_payment():
    amount = 145.6  # чтобы пользователь заплатил 150 с комиссией 3%
    external_id = request.args.get('externalId')
    user_id = request.args.get('userId')
